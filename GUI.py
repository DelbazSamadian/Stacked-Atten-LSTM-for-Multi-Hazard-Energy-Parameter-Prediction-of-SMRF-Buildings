...
st.markdown(
    ...
    <div class="app-header">
        <img src="{TEESSIDE_LOGO_URL}" alt="Teesside University Logo">
        <div>
            <h1>
                Total Energy Prediction App for SMRF Buildings Exposed to
                Sequential Earthquake–Flood Hazards
            </h1>
            ...
            <p>
                ...
                Delbaz Samadian, Annalisa Occhipinti,
                Imrose B. Muhit, Nashwan Dawood
            </p>

            <p style="margin-top: 10px;">
                This open-access research app predicts the Total Energy response
                of steel special moment-resisting frame (SMRF) buildings exposed
                to sequential earthquake and flood scenarios using the trained
                hybrid Attention-LSTM surrogate model.
            </p>

            <div style="margin-top: 10px;">
                <h3>How the App Works</h3>
                <ul>
                    <li>Select the earthquake intensity and flood height.</li>
                    <li>
                        Set the ground-motion time step (Δt) when required and
                        upload acceleration records in the X and Y directions.
                    </li>
                    <li>
                        Specify the building using a reference building, the
                        quick custom mode, or the full structural-input CSV mode.
                    </li>
                    <li>
                        Click <strong>Predict Total Energy</strong> to estimate
                        the multi-hazard energy response.
                    </li>
                </ul>
            </div>
        </div>
